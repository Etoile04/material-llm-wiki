...
## Related Work
- [[wiki/summaries/2005_Rest_RecrystallizationSwellingUO2UMo|2005_Rest_RecrystallizationSwellingUO2UMo]] — Rest 的再结晶-肿胀模型为本文预转变阶段气泡数据提供了理论框架
- [[wiki/summaries/2011_Kim_FissionProductInducedSwellingUMo|2011_Kim_FissionProductInducedSwellingUMo]] — Kim (2011) 直接基于本文的 RERTR 数据建立了完整的 U-Mo 肿胀经验关联
- [[wiki/summaries/2015_Cui_MechanisticGaseousSwellingUMoUMo|2015_Cui_MechanisticGaseousSwellingUMoUMo]] — Cui (2015) 发展了 U-Mo 力学肿胀模型，以本文的晶间气泡数据为校验基准
- [[wiki/entities/Recrystallization|Recrystallization]] — 本文观察到晶粒细化转变点 (~3×10²¹ f/cm³) 是再结晶的触发条件
- [[wiki/entities/FissionGasDiffusion|FissionGasDiffusion]] — 晶界扩散增强因子 ξ=7×10³ 是本文对气体扩散动力学的重要贡献
- [[wiki/concepts/SwellingMechanisms|SwellingMechanisms]] — 预转变阶段晶间气泡肿胀是 U-Mo 低温肿胀机制的重要组成部分

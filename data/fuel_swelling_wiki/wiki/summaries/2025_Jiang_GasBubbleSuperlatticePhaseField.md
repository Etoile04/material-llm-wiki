...
## Related Work
- [[wiki/summaries/2016_Hu_GasBubbleSuperlatticeFormationPF|2016_Hu_GasBubbleSuperlatticeFormationPF]] — Hu建立1D SIA扩散机制，本文将其扩展至多晶体系并加入晶界效应
- [[wiki/summaries/2023_Zhang_Review_VoidBubbleSuperlattice_SelfOrganization|2023_Zhang_Review_VoidBubbleSuperlattice_SelfOrganization]] — GBS自组织理论综述，本文的1D SIA阴影效应是其中理论的具体实现
- [[wiki/summaries/2024_Aagesen_VacancyProductionPF|2024_Aagesen_VacancyProductionPF]] — 空位产生率参数化，与本文的KKS相场空位源项直接相关
- [[wiki/summaries/2023_Smith_EarlySelfOrganizationGBS|2023_Smith_EarlySelfOrganizationGBS]] — 实验观测GB~30-107 nm范围内有序化，本文的贫化区/峰值区模型可解释该现象
- [[wiki/summaries/2025_Aagesen_PhaseTransformation_Superlattice|2025_Aagesen_PhaseTransformation_Superlattice]] — Aagesen同期超晶格相变相场研究
- [[wiki/entities/GasBubbleSuperlattice|GasBubbleSuperlattice]] — 本文的KKS相场+显式形核算法是目前GBS形成模拟的最完整相场实现

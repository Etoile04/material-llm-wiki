...
- [[wiki/summaries/2020_Williams_PIRT_SwellingUZr/PhysicalMechanisms|2020_Williams_PIRT_SwellingUZr/PhysicalMechanisms]] — Swelling driving forces, constituent redistribution zones, phase-dependent behavior
- [[wiki/summaries/2020_Williams_PIRT_SwellingUZr/PIRTFramework|2020_Williams_PIRT_SwellingUZr/PIRTFramework]] — PIRT weighting formula, full results table, key parameters, modeling approaches
- [[wiki/summaries/2020_Williams_PIRT_SwellingUZr/ExperimentalData|2020_Williams_PIRT_SwellingUZr/ExperimentalData]] — EBR-II / FFTF / AFC irradiation data, JSRT calibration parameters
...
- [[wiki/summaries/2013_Karahan_FEAST_ExtendedSwelling_UPuZr|2013_Karahan_FEAST_ExtendedSwelling_UPuZr]] — FEAST-METAL extended swelling model cited here
...
## Related Work
- [[wiki/summaries/1993_Rest_VoidSwellingAlphaU|1993_Rest_VoidSwellingAlphaU]] — α-U空泡肿胀模型，PIRT评估的核心参考
- [[wiki/summaries/2020_Aagesen_BisonUPuZrSwellingLowerLengthScale|2020_Aagesen_BisonUPuZrSwellingLowerLengthScale]] — BISON中U-Pu-Zr肿胀模型的介观改进
- [[wiki/summaries/2013_Karahan_FEAST_ExtendedSwelling_UPuZr|2013_Karahan_FEAST_ExtendedSwelling_UPuZr]] — FEAST-METAL肿胀模型，PIRT中被评估的竞争模型之一
- [[wiki/summaries/1990_Hofman_SwellingBehaviorUPuZr|1990_Hofman_SwellingBehaviorUPuZr]] — U-Pu-Zr肿胀行为的经典实验参考
- [[wiki/concepts/ConstituentRedistribution|ConstituentRedistribution]] — Zr组分再分布机制的概念综述
- [[wiki/concepts/SwellingModelComparison|SwellingModelComparison]] — 多个肿胀模型的比较框架

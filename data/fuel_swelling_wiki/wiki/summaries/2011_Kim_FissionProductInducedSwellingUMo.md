...
- [[wiki/summaries/2015_Cui_MechanisticGaseousSwellingUMoUMo|2015_Cui_MechanisticGaseousSwellingUMoUMo]] — Cui (2015) develops a mechanistic model building on the empirical framework here
...
## Related Work
- [[wiki/summaries/2008_Kim_IntergranularFGBubblesUMo|2008_Kim_IntergranularFGBubblesUMo]] — Kim (2008) 的预转变晶间气泡数据直接输入本文的肿胀模型
- [[wiki/summaries/2005_Rest_RecrystallizationSwellingUO2UMo|2005_Rest_RecrystallizationSwellingUO2UMo]] — Rest 的再结晶-肿胀耦合理论为本文的两阶段肿胀行为提供了物理解释
- [[wiki/summaries/2015_Cui_MechanisticGaseousSwellingUMoUMo|2015_Cui_MechanisticGaseousSwellingUMoUMo]] — Cui (2015) 在本文经验框架基础上发展了 U-Mo 力学肿胀模型
- [[wiki/summaries/1985_Willard_SwellingPhaseReversionU10Mo|1985_Willard_SwellingPhaseReversionU10Mo]] — Willard 早期建立的 U-10Mo 辐照行为基线与本文的现代数据形成跨时代对比
- [[wiki/entities/Recrystallization|Recrystallization]] — 晶粒细化阈值 (~3×10²⁷ fissions/m³) 是本文两阶段肿胀行为的物理转折点
- [[wiki/concepts/SwellingMechanisms|SwellingMechanisms]] — 固体裂变产物肿胀 + 裂变气体气泡肿胀的双组分模型是本文的核心框架

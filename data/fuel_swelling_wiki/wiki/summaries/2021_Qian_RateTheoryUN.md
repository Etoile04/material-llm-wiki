...
## Related Work
- [[wiki/summaries/2001_Rest_GRSIS_FissionGasMetallic|2001_Rest_GRSIS_FissionGasMetallic]] — GRSIS裂变气体模型，可替代的速率理论方法
- [[wiki/summaries/1993_Rest_VoidSwellingAlphaU|1993_Rest_VoidSwellingAlphaU]] — GRASS-SST框架的基础，本文模型的方法论前身
- [[wiki/summaries/1979_Ronchi_FissionGasSwellingMX_Fuels|1979_Ronchi_FissionGasSwellingMX_Fuels]] — MX燃料速率方程模型，方法论的早期先驱
- [[wiki/summaries/2022_Qian_U10Zr_CavitationalVoidSwelling|2022_Qian_U10Zr_CavitationalVoidSwelling]] — Qian团队后续将速率理论应用于U-10Zr
- [[wiki/concepts/RateTheoryFramework|RateTheoryFramework]] — 速率理论框架的概念综述
- [[wiki/entities/FissionGasDiffusion|FissionGasDiffusion]] — 裂变气体扩散机制，本文确定了新的Xe扩散系数

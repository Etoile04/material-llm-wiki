...
## Related Work
- [[wiki/summaries/1993_Rest_VoidSwellingAlphaU|1993_Rest_VoidSwellingAlphaU]] — Rest(1993)空穴肿胀模型是本文的直接理论基础
- [[wiki/summaries/1992_Rest_CavitationalSwellingAlphaUPuZr|1992_Rest_CavitationalSwellingAlphaUPuZr]] — Rest早期会议论文，提供初始参数集
- [[wiki/summaries/2020_Aagesen_BisonUPuZrSwellingLowerLengthScale|2020_Aagesen_BisonUPuZrSwellingLowerLengthScale]] — Aagesen同样重新审视了空穴肿胀模型并用于BISON
- [[wiki/summaries/2004_Okita_CriticalTest_RateTheory_VoidSwelling|2004_Okita_CriticalTest_RateTheory_VoidSwelling]] — 速率理论空洞肿胀的关键验证实验
- [[wiki/concepts/LowTemperatureSwellingMechanisms|LowTemperatureSwellingMechanisms]] — 本文是低温肿胀机理(400–600 K)的典型案例
- [[wiki/entities/CavitationalVoid|CavitationalVoid]] — 本文核心物理机制，DFT修正的空位迁移能(0.34 eV)是关键贡献

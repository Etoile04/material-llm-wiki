...
- [[wiki/summaries/2015_Cui_MechanisticGaseousSwellingUMoUMo|Cui 2015]] — mechanistic swelling model for comparison

## Related Work
- [[wiki/summaries/2018_Liang_3DPhaseFieldIntragranularBubbleUMo|2018_Liang_3DPhaseFieldIntragranularBubbleUMo]] — 3D phase-field model for intragranular bubbles; similar grain size effect findings
- [[wiki/summaries/2015_Cui_MechanisticGaseousSwellingUMoUMo|2015_Cui_MechanisticGaseousSwellingUMoUMo]] — mechanistic gaseous swelling model for U-Mo with FE coupling
- [[wiki/summaries/2013_Kim_RecrystallizationFGBSwellingUMo|2013_Kim_RecrystallizationFGBSwellingUMo]] — recrystallization threshold defines validity boundary of this pre-rx Booth model
- [[wiki/summaries/2022_Jian_FissionGasSwellingModelU10Mo|2022_Jian_FissionGasSwellingModelU10Mo]] — later mechanistic fission gas model for U-10Mo
- [[wiki/entities/FissionGasDiffusion|FissionGasDiffusion]] — athermal fission gas diffusion is the core transport mechanism modeled
- [[wiki/concepts/RateTheoryFramework|RateTheoryFramework]] — rate-equation framework underpinning the generalized Booth model

...
## Related Work
- [[wiki/summaries/2025_Hanson_StablePredictableSwellingU10Mo|2025_Hanson_StablePredictableSwellingU10Mo]] — MP-1实验确认至6×10²¹ f/cm³无breakaway，本文将数据延伸至9.4×10²¹ f/cm³
- [[wiki/summaries/2021_Robinson_PredictiveSwellingUMoMonolithic|2021_Robinson_PredictiveSwellingUMoMonolithic]] — Robinson-Williams经验模型，本文的高燃耗数据验证了其预测范围
- [[wiki/summaries/2022_Jian_FissionGasSwellingModelU10Mo|2022_Jian_FissionGasSwellingModelU10Mo]] — Jian机理模型的高燃耗预测可由本文的双峰孔隙率数据检验
- [[wiki/summaries/2015_Gan_ThermalStabilityGasBubbleSuperlattice|2015_Gan_ThermalStabilityGasBubbleSuperlattice]] — GBS热稳定性，本文中再结晶后GBS塌陷→大孔隙演化的过程与其衔接
- [[wiki/concepts/SwellingMechanisms|SwellingMechanisms]] — 本文首次系统表征了再结晶后U-Mo的双峰孔隙率演化和互连孔隙亚层
- [[wiki/concepts/GasBubbleCoalescence|GasBubbleCoalescence]] — 高燃耗下小气泡密度减少、大气泡持续增长是本文观测到的coalescence主导转变

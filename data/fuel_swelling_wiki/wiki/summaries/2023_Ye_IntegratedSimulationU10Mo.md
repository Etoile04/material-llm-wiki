...
- [[wiki/summaries/2023_Ye_IntegratedSimulationU10Mo/PhysicalMechanisms|2023_Ye_IntegratedSimulationU10Mo/PhysicalMechanisms]] — nucleation, re-solution, coalescence, gas migration, recrystallization
- [[wiki/summaries/2023_Ye_IntegratedSimulationU10Mo/KeyEquations|2023_Ye_IntegratedSimulationU10Mo/KeyEquations]] — Xe diffusivity, nucleation rates, re-solution, calibrated parameters
- [[wiki/summaries/2023_Ye_IntegratedSimulationU10Mo/ModelArchitecture|2023_Ye_IntegratedSimulationU10Mo/ModelArchitecture]] — DART/GRASS code, three-level meshing, calibration plates, key findings
...
## Related Work
- [[wiki/summaries/2022_Jian_FissionGasSwellingModelU10Mo|2022_Jian_FissionGasSwellingModelU10Mo]] — Jian机理肿胀模型，与DART/GRASS方法互为对照
- [[wiki/summaries/2023_Li_ElasticConstantsU10Mo|2023_Li_ElasticConstantsU10Mo]] — 同领域弹性常数退化模型，可为DART热力学耦合提供输入
- [[wiki/summaries/2001_Rest_GRSIS_FissionGasMetallic|2001_Rest_GRSIS_FissionGasMetallic]] — GRASS模块的方法论起源
- [[wiki/summaries/2025_Hanson_StablePredictableSwellingU10Mo|2025_Hanson_StablePredictableSwellingU10Mo]] — MP-1实验数据可用于验证DART预测的肿胀行为
- [[wiki/summaries/2022_Hanson_EMPIrESwellingAnalysis|2022_Hanson_EMPIrESwellingAnalysis]] — EMPIrE实验肿胀数据，作为DART验证的输入
- [[wiki/entities/RateTheory|RateTheory]] — DART/GRASS基于速率理论ODE框架

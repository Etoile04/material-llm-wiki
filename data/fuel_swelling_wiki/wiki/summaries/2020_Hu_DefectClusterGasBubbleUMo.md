...
## Related Work
- [[wiki/summaries/2020_Beeler_ImprovedEOSXeBubbleUMo|2020_Beeler_ImprovedEOSXeBubbleUMo]] — 为本模型提供Xe气泡热力学输入的改进EOS
- [[wiki/summaries/2018_Liang_3DPhaseFieldIntragranularBubbleUMo|2018_Liang_3DPhaseFieldIntragranularBubbleUMo]] — 本工作延伸的3D相场晶内气泡模型
- [[wiki/summaries/2017_Hu_RateTheory_PhaseField_Recrystallization_UMo|2017_Hu_RateTheory_PhaseField_Recrystallization_UMo]] — 同一团队的速率理论+相场再结晶模型
- [[wiki/summaries/2021_Robinson_PredictiveSwellingUMoMonolithic|2021_Robinson_PredictiveSwellingUMoMonolithic]] — 提供验证数据的U-10Mo肿胀关联
- [[wiki/entities/Recrystallization|Recrystallization]] — 再结晶驱动的晶粒细化与气泡动力学转变
- [[wiki/concepts/RateTheoryFramework|RateTheoryFramework]] — 团簇动力学速率方程的理论框架

...
## Related Work
- [[wiki/summaries/2015_Miller_TEMGasBubbleSuperlatticeU7Mo|2015_Miller_TEMGasBubbleSuperlatticeU7Mo]] — complementary TEM characterization of intragranular bubble superlattice at lower burnup
- [[wiki/summaries/2015_Gan_ThermalStabilityGasBubbleSuperlattice|2015_Gan_ThermalStabilityGasBubbleSuperlattice]] — thermal stability of GBS relevant to pre-recrystallization bubble state
- [[wiki/summaries/2016_Hu_GrainMorphologyGasBubbleUMo|2016_Hu_GrainMorphologyGasBubbleUMo]] — rate-theory model predicting bubble structures before recrystallization
- [[wiki/summaries/2013_Kim_RecrystallizationFGBSwellingUMo|2013_Kim_RecrystallizationFGBSwellingUMo]] — recrystallization model explaining transition from nm-scale to μm-scale bubbles
- [[wiki/summaries/2021_Hilty_FissionGasBubblesThermalConductivity|2021_Hilty_FissionGasBubblesThermalConductivity]] — thermal conductivity degradation from fission gas bubbles
- [[wiki/entities/Recrystallization|Recrystallization]] — post-recrystallization state of the characterized sample

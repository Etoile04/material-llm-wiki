...
## Related Work
- [[wiki/summaries/2025_Hanson_StablePredictableSwellingU10Mo|2025_Hanson_StablePredictableSwellingU10Mo]] — 后续单板U-10Mo肿胀验证实验(MP-1)，确认无breakaway肿胀至6×10²¹ f/cm³
- [[wiki/summaries/2026_FigueroaBengoa_HighBurnupPorosityUMo|2026_FigueroaBengoa_HighBurnupPorosityUMo]] — 高燃耗U-Mo孔隙率演化数据，延伸EMPIrE燃耗范围
- [[wiki/summaries/2023_Ye_IntegratedSimulationU10Mo|2023_Ye_IntegratedSimulationU10Mo]] — DART/GRASS机理模拟，为EMPIrE实验数据提供理论对照
- [[wiki/summaries/2021_Robinson_PredictiveSwellingUMoMonolithic|2021_Robinson_PredictiveSwellingUMoMonolithic]] — Robinson经验肿胀模型，EMPIrE分析直接使用的局部肿胀方法论
- [[wiki/summaries/2013_Kim_RecrystallizationFGBSwellingUMo|2013_Kim_RecrystallizationFGBSwellingUMo]] — Kim再结晶肿胀经验模型，作为EMPIrE的背景对比模型
- [[wiki/concepts/SwellingModelComparison|SwellingModelComparison]] — EMPIrE对多种制造变量的统计分析代表了实验性模型比较方法

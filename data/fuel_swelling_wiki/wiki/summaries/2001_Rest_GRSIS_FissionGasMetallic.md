...
- [[wiki/summaries/2013_Karahan_FEAST_ExtendedSwelling_UPuZr|2013_Karahan_FEAST_ExtendedSwelling_UPuZr]] — FEAST-METAL uses the GRSIS algorithm as its fission gas behavior module

## Related Work
- [[wiki/summaries/1990_Hofman_SwellingBehaviorUPuZr|1990_Hofman_SwellingBehaviorUPuZr]] — Hofman 的 U-Pu-Zr 肿胀数据是 GRSIS 模型校准和验证的主要数据来源
- [[wiki/summaries/1993_Rest_VoidSwellingAlphaU|1993_Rest_VoidSwellingAlphaU]] — Rest 的空腔模型处理了 GRSIS 未涉及的 α-U 相低温空腔肿胀
- [[wiki/summaries/2013_Karahan_FEAST_ExtendedSwelling_UPuZr|2013_Karahan_FEAST_ExtendedSwelling_UPuZr]] — FEAST-METAL 直接采用 GRSIS 算法作为裂变气体行为模块
- [[wiki/concepts/SwellingModelComparison|SwellingModelComparison]] — GRSIS 的各向同性气泡肿胀与 Rest 的空腔肿胀是两种竞争范式
- [[wiki/concepts/RateTheoryFramework|RateTheoryFramework]] — GRSIS 基于速率方程描述气泡形核、长大和合并
- [[wiki/entities/FuelAlloy|FuelAlloy]] — U-Pu-Zr 金属燃料合金是 GRSIS 的建模对象
